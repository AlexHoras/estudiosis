...
<section class="cadastraUsuarios">
    <div class="centraliza">
        <form method="POST" action="{{ route('usuarios.cadstr') }}" class="form-group col-md-12">
            @csrf
            <h2 class="form-label">Cadastrar Usúario</h2>
            <div class="form-floating col-md-12">
                <input type="text" class="form-control" name="nome" id="floatingInput" placeholder="Nome Usúario" required>
                <label for="floatingInput">Nome do usúario</label>
            </div>
            <div class="form-floating col-md-12">
              <input type="text" class="form-control" name="user" id="floatingInput" placeholder="Nome Usúario" required>
            ...
            <div class="form-group col-md-12">
                <select class="form-select" name="nivel" id="exampleSelect1" placeholder="Tipo" required>
                <option>...</option>
