...
<section class="cadastraUsuarios">
    <div class="centraliza">
        <form method="POST" action="{{ route('cadstrCliente') }}" class="form-group col-md-12">
            @csrf
            <h2 class="form-label">Cadastrar Cliente</h2>
            <div class="form-floating col-md-12">
                <input type="text" class="form-control" name="name" id="floatingInput" placeholder="Nome Usúario" required>
